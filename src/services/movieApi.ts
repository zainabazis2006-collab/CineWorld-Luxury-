...
export const OFFICIAL_MEDIA_MAP: Record<string, MovieMediaData> = {
  ...
  'dhurandhar-raw-and-andekha': { youtubeId: 'ZNeGF-PvKbE' },
  'dhurandar-raw-and-andekha': { youtubeId: 'ZNeGF-PvKbE' },
  'dhurandhar-the-revenge': { youtubeId: 'ZNeGF-PvKbE' },
  'dhurandar-the-revenge': { youtubeId: 'ZNeGF-PvKbE' },
