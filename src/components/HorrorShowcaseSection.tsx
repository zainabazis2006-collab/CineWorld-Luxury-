              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className={`flex-1 sm:flex-initial px-4 py-3 rounded-xl font-bold uppercase text-[10px] tracking-wider border transition-all duration-300 flex items-center justify-center gap-2 ${
                    isWatchlisted
                      ? 'bg-red-950/20 text-red-400 border-red-900/40 hover:bg-red-950/30'
                      : 'bg-white/5 hover:bg-white/10 text-white border-white/10'
                  }`}
                >
                  {isWatchlisted ? <Check className="w-3.5 h-3.5 text-red-500" /> : <Plus className="w-3.5 h-3.5" />}
                ...
                <button
                  ...
                  className="flex-1 sm:flex-initial px-5 py-3 rounded-xl bg-red-600 hover:bg-red-700 text-white font-bold uppercase text-[10px] tracking-wider transition-all duration-300 shadow-[0_0_20px_rgba(220,38,38,0.35)] hover:shadow-[0_0_25px_rgba(220,38,38,0.55)] flex items-center justify-center gap-2"
                >
