          ...
          <div className="p-6 sm:p-8 space-y-6 flex-1 flex flex-col justify-between">
            ...
            <div className="pt-6 border-t border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-4 mt-6">
              ...
              <div className="flex items-center gap-3">
                ...
                >
                  {isWatchlisted ? <Check className="w-3.5 h-3.5 text-pink-400" /> : <Plus className="w-3.5 h-3.5" />}
                ...
                <button
                  ...
                  className="flex-1 sm:flex-initial px-5 py-3 rounded-xl bg-pink-500 hover:bg-pink-600 text-white font-bold uppercase text-[10px] tracking-wider transition-all duration-300 shadow-[0_0_20px_rgba(236,72,153,0.3)] hover:shadow-[0_0_25px_rgba(236,72,153,0.5)] flex items-center justify-center gap-2"
                >
